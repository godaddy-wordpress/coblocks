...
With the extension installed, ESLint will use the [.eslintrc.js](https://github.com/godaddy-wordpress/coblocks/blob/master/.eslintrc.js) file in the root of the CoBlocks repository for formatting rules. It will highlight issues as you develop, you can also set the following preference to fix lint rules on save.
