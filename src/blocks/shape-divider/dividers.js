...
dividers.sloped =
	<SVG className="divider--sloped" aria-hidden xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="none"><Path d="M0 100 C 20 0 50 0 100 100 Z"></Path></SVG>;

dividers.rounded =
	<SVG className="divider--rounded" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 240 24" enableBackground="new 0 0 240 24" preserveAspectRatio="none">
...
dividers.triangle =
	<SVG className="divider--triangle" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"><Path d="m0 0 50 100 50-100z" fillRule="evenodd" transform="matrix(1 0 0 -1 0 100)" /></SVG>;
