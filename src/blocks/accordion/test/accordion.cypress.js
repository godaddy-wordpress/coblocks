...
describe( 'Block: Accordion', () => {
	...
	it( 'can apply color settings', () => {
		...
		cy.get( '[data-type="coblocks/accordion-item"] [data-type="core/paragraph"]' ).click().type( 'Content' );

		// Content - Background color
		helpers.setColorSetting( 'background', '#000000' );
		cy.get( '[data-type="coblocks/accordion-item"] [data-type="core/paragraph"]' ).should( 'have.css', 'background-color', `rgb(0, 0, 0)` );

		// Content - Text color
		helpers.setColorSetting( 'text', '#FFFFFF' );
		cy.get( '[data-type="coblocks/accordion-item"] [data-type="core/paragraph"]' ).should( 'have.css', 'color', `rgb(255, 255, 255)` );
