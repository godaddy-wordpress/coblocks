...
const TEMPLATE = [
	[ 'coblocks/row', { columns: 1, align: 'full', layout: '100', paddingSize: 'huge', hasMarginControl: false, hasStackedControl: false, hasAlignmentControls: false, customBackgroundColor: '#FFFFFF' }, [
