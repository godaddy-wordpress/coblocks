...
const TEMPLATE = [
	[ 'core/heading', { placeholder: __( 'Add hero heading…', 'coblocks' ), level: 2 } ],
	...
	[ 'coblocks/buttons', { contentAlign: 'left', items: 2, gutter: 'medium' },
		[
			[ 'core/button', { placeholder: __( 'Primary button…', 'coblocks' ) } ],
			[ 'core/button', { placeholder: __( 'Secondary button…', 'coblocks' ), className: 'is-style-outline' } ],
		],
	],
];
