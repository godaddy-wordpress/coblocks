...
describe( 'coblocks/field-phone transforms', () => {
	// Shared attributes
	const attributes = {
		required: false,
	};
	...
	it( 'should transform from coblocks/field-name block', () => {
		...
		const transformed = switchToBlockType( coBlocksDateBlock, 'coblocks/field-phone' );
	...
	it( 'should transform from coblocks/field-date block', () => {
		...
		const transformed = switchToBlockType( coBlocksTextareaBlock, 'coblocks/field-phone' );
	...
	it( 'should transform from coblocks/field-textarea block', () => {
		...
		const transformed = switchToBlockType( coBlocksPhoneBlock, 'coblocks/field-phone' );
	...
	it( 'should transform from coblocks/field-text block', () => {
		...
		const transformed = switchToBlockType( coBlocksTextBlock, 'coblocks/field-phone' );
	...
	it( 'should transform from coblocks/field-website block', () => {
		...
		const transformed = switchToBlockType( coBlocksWebsiteBlock, 'coblocks/field-phone' );
	...
	it( 'should transform from coblocks/field-hidden block', () => {
		...
		const transformed = switchToBlockType( coBlocksHiddenBlock, 'coblocks/field-phone' );
