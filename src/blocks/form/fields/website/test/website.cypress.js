...
describe( 'Test CoBlocks Form Block', function() {
	/**
	 * Test the coblocks form website field transforms.
	 */
	it( 'should transform from coblocks/field-website block to coblocks/field-date, coblocks/field-name, coblocks/field-textarea, coblocks/field-phone, coblocks/field-text, coblocks/field-hidden', function() {
		...
		for ( var index = 0; index < blocksToTransformTo.length; index++ ) {
			...
			// Switch the website field to another type.
			cy.get( '[data-type="coblocks/field-website"]' )
				.click( { force: true } );
			...
			// Check the website field transformed properly.
