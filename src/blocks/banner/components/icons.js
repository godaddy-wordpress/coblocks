...
icons.banner =
<SVG className="dashicon components-coblocks-svg" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><Path d="m20 0c1.1 0 2 .9 2 2v10c0 1.1-.9 2-2 2h-18c-1.1 0-2-.9-2-2v-10c0-1.1.9-2 2-2zm-18 4v2h9v-2zm0 4v2h7v-2zm11.0015869-2.5v3h7v-3zm2 1h3v1h-3z" transform="translate(1 5)"/></SVG>
