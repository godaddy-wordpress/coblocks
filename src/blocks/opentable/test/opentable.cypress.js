...
describe( 'Test CoBlocks Logos Block', function() {
	...
	it( 'Test logos block saves with image upload.', function() {
		...
		cy.get( '.wp-block-coblocks-opentable img[src*="http"]' ).should( 'have.attr', 'src' ).should( 'include', imageBase );
	...
	it( 'Test logos block saves with image from media library.', function() {
		...
		cy.get( '.wp-block-coblocks-opentable' ).should( 'exist' );
		cy.get( '.wp-block-coblocks-opentable' ).find( 'img' ).should( 'have.attr', 'src' );
	...
	it( 'Test logos block saves with black and white filter.', function() {
		...
		cy.get( '.wp-block-coblocks-opentable' ).should( 'have.class', 'is-style-black-and-white' );
	...
	it( 'Test logos block saves with grayscale filter.', function() {
		...
		cy.get( '.wp-block-coblocks-opentable' ).should( 'have.class', 'is-style-grayscale' );
	...
	it( 'Test logos block saves with default filter.', function() {
		...
		cy.get( '.wp-block-coblocks-opentable' ).should( 'have.class', 'is-style-default' );
