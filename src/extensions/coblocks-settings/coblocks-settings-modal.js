...
const applyWithSelect = withSelect( () => {
	const { getAnimation, getTypography, getCustomColors, getGradients, getColorPanel, getLayoutSelector } = select( 'coblocks/coblocks-settings' );
...
const applyWithDispatch = withDispatch( ( dispatch ) => {
	const {
		...
		setLayoutSelector,
		setTypography,
	} = dispatch( 'coblocks/coblocks-settings' );
