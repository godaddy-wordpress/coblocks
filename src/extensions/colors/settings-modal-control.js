...
function CoBlocksEditorSettingsControls() {
	...
	useEffect( () => {
		...
		if ( colorPanelEnabled && prevColorSettings.current?.colors ) {
			newSettings = {
				...newSettings,
				colors: coblocksBlockData.defaultColorSettings.colors,
				disableCustomColors: false,
				disableCustomGradients: false,
				gradients: coblocksBlockData.defaultColorSettings.gradients,
				...
				__experimentalFeatures: {
					...
					color: {
						...settings?.__experimentalFeatures?.color,
						palette: {
							...coblocksBlockData.defaultColorSettings.__experimentalFeatures.color.palette,
						},
						gradients: {
							...coblocksBlockData.defaultColorSettings.__experimentalFeatures.color.gradients,
						},
					},
				},
				/* eslint-enable sort-keys */
