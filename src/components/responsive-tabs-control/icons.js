...
icons.mobile =
	<SVG aria-hidden className="dashicon" role="img" focusable="false" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
...
icons.desktopChrome =
	<SVG aria-hidden className="dashicon dashicon--desktop-chrome" role="img" focusable="false" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
