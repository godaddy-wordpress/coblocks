		...
		<div class="coblocks--about-wrap-fixed">
			...
			<div class="coblocks--about-wrap">
				...
				<div class="about-description">
					...
					<img class="hero-image" src="<?php echo esc_url( COBLOCKS_PLUGIN_URL . 'dist/images/admin/hero.png' ); ?>" alt="Watch how to create your first form">

					<p><?php echo sprintf( esc_html__( 'You\'ve just added lots of useful blocks and a new page builder toolkit to the WordPress editor. CoBlocks gives you a game-changing set of features: %1$stens blocks%2$s, a %1$spage-builder experience%2$s, %1$stypography controls%2$s and a new %1$sBlock Manager%2$s for turning blocks off.', '@@textdomain' ), '<strong>', '</strong>' ); ?></p>

					<p><strong><?php echo esc_html__( 'Here are a few videos showing what you can do with CoBlocks:', '@@textdomain' ); ?></strong></p>

					<div class="videos video-frame">
						<a href="https://youtube.com/watch?v=EsIpvCcTKPw" title="<?php echo sprintf( esc_attr__( 'Watch how to create your first page with %s', '@@textdomain' ), 'CoBlocks' ); ?>" data-lity>
							<img src="<?php echo esc_url( COBLOCKS_PLUGIN_URL . 'dist/images/admin/video.jpg' ); ?>" alt="Watch how to create your first form">
						</a>
						<a href="https://youtube.com/watch?v=cAQC_L03Z70" title="Watch how to create your first form" data-lity>
							<img src="<?php echo esc_url( COBLOCKS_PLUGIN_URL . 'dist/images/admin/video-2.jpg' ); ?>" alt="Watch how to create your first form">
						</a>
						<a href="https://youtube.com/watch?v=SZOMMtrd0nw" title="Watch how to create your first form" data-lity>
							<img src="<?php echo esc_url( COBLOCKS_PLUGIN_URL . 'dist/images/admin/video-3.jpg' ); ?>" alt="Watch how to create your first form">
						</a>
					</div>

					<p>Like what you see? <a href="https://www.youtube.com/channel/UCsOcD4k5eUBH_wWhcxPJZcA" target="_blank">Subscribe to our YouTube channel</a> and we'll let you know when new video tutorials are released.</p>

					<p><?php echo sprintf( esc_html__( 'If you have any questions or feedback, let us know on %1$sTwitter%2$s or our %3$sFacebook group %4$s. Also, %5$ssubscribe to our newsletter%6$s if you want to stay up to date with what\'s new and upcoming at CoBlocks. Enjoy!', '@@textdomain' ), '<a href="https://twitter.com/coblocks" target="_blank">', '</a>', '<a href="https://www.facebook.com/groups/coblocks" target="_blank">', '</a>', '<a href="https://coblocks.us20.list-manage.com/subscribe?u=fd78cec472f9f62b76fca64d1&id=62cbc3526f" target="_blank">', '</a>' ); ?></p>
