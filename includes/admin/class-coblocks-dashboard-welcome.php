			...
			<div class="about-description">
				...
				<p>
					...
					echo sprintf(
						...
						esc_attr__( 'Like what you see? %1$sSubscribe to our YouTube channel%2$s and we\'ll let you know when new video tutorials are released.', '@@textdomain' ), '<a href="https://www.youtube.com/channel/UCsOcD4k5eUBH_wWhcxPJZcA">', '</a>'
					);
					?>
				</p>
