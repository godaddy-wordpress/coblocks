			...
			<div class="getting-started__content">
				...
				<p>
					...
					echo sprintf(
						...
						esc_attr__( 'Like what you see? %1$sSubscribe to our YouTube channel%2$s and we\'ll let you know when new video tutorials are released.', '@@textdomain' ),
				...
				<p>
					...
					echo sprintf(
						...
						esc_html__( 'If you have any questions or feedback, let us know on %1$sTwitter%4$s or our %2$sFacebook group %4$s. Also, %3$ssubscribe to our newsletter%4$s if you want to stay up to date with what\'s new and upcoming at CoBlocks.', '@@textdomain' ),
