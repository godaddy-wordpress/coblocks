...
class CoBlocks_Social_Index_Tests extends WP_UnitTestCase {
	...
	public function test_coblocks_render_social_block_with_thumbnail() {
		...
		$this->assertRegExp( '/<a href="https:\/\/pinterest.com\/pin\/create\/button\/\?&#038;url=http:\/\/example.org\/\?p=17&#038;description=CoBlocks%20Social&#038;media=http:\/\/example.org\/wp-content\/uploads\/2019\/06\/cat-pet-animal-domestic-104827[-0-9]+-1024x680.jpeg" class="wp-block-button__link wp-block-coblocks-social__button wp-block-coblocks-social__button--pinterest    " title="Share on Pinterest" style="">/', coblocks_render_social_block( $attributes ) );
